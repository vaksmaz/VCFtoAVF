...
sys.path.append('../')
from pvs import PVS1
from pvs.read_data import transcripts, genome, trans_gene, gene_trans
from pvs.utils import vep2vcf, get_transcript, vep_consequence_trans, VCFRecord
